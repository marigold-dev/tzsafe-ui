...
function Modal(props: React.PropsWithChildren<{ opened: boolean }>) {
  return props.opened
    ? ReactDOM.createPortal(
        <div className="overflow-y-none fixed top-0 left-0 right-0 bottom-0 z-10 flex h-fit min-h-full grow items-center justify-center bg-slate-800 bg-opacity-70 md:left-72">
