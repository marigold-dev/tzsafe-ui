...
function Modal(props: React.PropsWithChildren<{ opened: boolean }>) {
  return props.opened
    ? ReactDOM.createPortal(
        <div className="bg-slate-800 bg-opacity-70 absolute grow min-h-full h-fit top-0 left-0 right-0 bottom-0 flex justify-center items-center z-10 overflow-y-none">
